"""
Clean updated endpoint for single document consolidation
"""
...
async def get_aggregated_template_fields_consolidated(bank_code: str, template_id: str) -> JSONResponse:
    """
    Clean consolidated endpoint that works with unified bank document structure.
    """
    try:
