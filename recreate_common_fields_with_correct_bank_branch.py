#!/usr/bin/env python3
"""
Recreate common_form_fields with corrected bank_branch configuration
Author: System
Date: 2024-01-20
...
async def main():
    print("Starting common_form_fields recreation with corrected bank_branch...")
    ...
    try:
        ...
        common_fields_document = {
            ...
            "version": 2,
            "description": "Updated common form fields with corrected bank branch configuration"
        }
        
        print("Recreating common_form_fields document...")
        
        # Delete existing document first (if any)
        try:
            ...
            print(f"✓ Removed existing common_form_fields document")
        except Exception as e:
            print(f"ℹ No existing document to remove: {e}")
        
        # Insert new document
        result = await db_manager.insert_one(
            "admin",
            "common_form_fields",
            common_fields_document
        )
        ...
        if result:
            print("✓ Successfully recreated common_form_fields document")
    ...
    print("\n🎉 Common form fields recreation completed successfully!")
